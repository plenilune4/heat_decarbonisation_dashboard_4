                ...
                validationRules={[
                    ...
                    },
                    {
                        ...
                        isValid: (fieldValue) => {
                            ...
                            return fieldValue?.length && fieldValue?.length >= 10
                        },
                        prompt: 'Passwords should be at least 10 characters',
                    },
                    // {
                    //     field: 'password',
                    //     isValid: (fieldValue) => {
            ...
            >
                {(f) => (
                    <>
                        ...
                        <TextField {...f('organisation')} autoComplete='organisation' name='organisation' />
