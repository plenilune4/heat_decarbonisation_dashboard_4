        ...
        <div className='flex flex-col gap-y-16 justify-center py-10 mx-auto w-full max-w-5xl h-full'>
            ...
            <section className='flex flex-col gap-y-8 mt-auto text-center'>
                ...
                <p className='mx-auto max-w-3xl text-lg text-gray-400'>
                    ...
                    The Residential Decarbonisation Dashboard allows users to investigate the impact of different strategies for decarbonising residential heat in South Yorkshire.
                    The Dashboard was produced by South Yorkshire Sustainability Centre as part of Theme 1.3 'Residential Heat Decarbonisation'.
                </p>
            </section>
            ...
            <section className='flex flex-col gap-y-8 mb-auto'>
                <div className='grid gap-6 md:grid-cols-2'>
                    <div className='flex flex-col gap-y-4 p-6 rounded-xl border border-gray-700 bg-gray-800/80'>
                        ...
                        <p className='text-gray-300'>Start a new case study. You will define a region, locality or set of buildings to focus on, or use a previously saved set of buildings.  </p>
                        <Button.Success className='mt-auto w-full' onClick={() => navigate('/casestudies/new')}>
