...
import { convertBlobToBase64, isBase64WithinSizeLimit, processImageForBase64 } from '@/utils/image-utils'
...
function AvatarBase({
    ...
    return (
        <div
            className={cn(
                'flex relative justify-center items-center overflow-clip bg-gradient-to-b from-gray-700 to-gray-600 rounded-full group shrink-0',
                className
            )}
            style={{
                width: width,
...
function Avatar(props: AvatarBaseProps) {
    const strategyFromEnv = import.meta.env.VITE_PROFILE_IMAGE_STRATEGY as 'base64' | 'auto'
